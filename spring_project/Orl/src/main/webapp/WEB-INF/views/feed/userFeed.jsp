...
<body>
	...
	<div class="container1">
		...
		<section class="bio">
			...
			<div class="profile-info">
				...
				<ul class="follow-infos">
					...
					<li class="follows" id="follower"><a>팔로워 <span
							id="followerCount"> ${followerCount}</span></a></li>

					<li class="follows" id="following"><a>팔로잉 <span
							id="followingCount">${followingCount}</span></a></li>
				</ul>
				...
				<div class="buttons">
					<c:choose>
						<c:when
							test="${sessionScope.memberVo.memberIdx ne member.memberIdx}">
							<div id="follow-button-div">
								<input type="button" id="follow-button"
									class="${followRelation==0? 'buttons-area-yellow':'buttons-area-gray'}"
									value="${followRelation==0? '팔로우 시작하기': '팔로우 그만하기'}">
							</div>
						</c:when>

						<c:otherwise>
							<div>
								<a class="buttons-area-yellow"
									href="<c:url value="/member/mypage"/>">내 정보 수정</a>
							</div>
							<div>
								<a class="buttons-area-yellow modalbtn_createfeed">피드 올리기</a>
							</div>
						</c:otherwise>
					</c:choose>
				</div>
			...
			<div class="swiper-wrapper">
				...
				<c:forEach var="myCrewList" items="${myCrewList}">
					<div class="swiper-slide">
						<a
							href="<c:url value="/crew/detail?crewIdx=${myCrewList.crewIdx}"/>"
							class="crew"> <img
							src="<c:url value="/images/crew/${myCrewList.crewPhoto}"/>">
				...
				<!-- 크루 더 보기 -->
				<div class="swiper-slide">
					<a href="<c:url value="/crew/list"/>" class="crew"> <img
						src="<c:url value="/images/feed/feeds/more.png"/>" alt="">
						<div>MORE</div>
					</a>
				</div>
				<!-- 크루 더 보기 끝 -->
		...
		<div class="gallery-nav">
			<!-- 기본정렬 -->
			<div class="feed-icon" id="default-sort-Click">
				<input type="image"
					src="<c:url value="/images/feed/feeds/feedicon.png"/>">
			</div>
			<!-- 좋아요 정렬 -->
			<div class="heart-icon" id="like-sort-Click">
				<input type="image"
					src="<c:url value="/images/feed/feeds/redheart.png"/>">
			</div>
		</div>
		<!--갤러리 네비게이션 영역 끝 -->
		...
		<form>
			<section class="gallery" id="default-sort-gallery">
				<c:forEach var="feedGallery" items="${feedGallery}">
					<a class="item"> <img
						onclick="location.href='${pageContext.request.contextPath}/feed/feedview/${member.memberIdx}&${feedGallery.boardIdx}'"
						src="<c:url value="/images/feed/feedw/uploadfile/${feedGallery.boardPhoto}"/>"
						alt="기본">
					</a>
				</c:forEach>
			</section>
		...
		<section class="gallery display_none" id="like-sort-gallery">
			<c:forEach var="feedLikeGallery" items="${feedLikeGallery}">
				<a class="item"> <img
					onclick="location.href='${pageContext.request.contextPath}/feed/feedview/${feedLikeGallery.memberIdx}&${feedLikeGallery.boardIdx}'"
					src="<c:url value="/images/feed/feedw/uploadfile/${feedLikeGallery.boardPhoto}"/>"
					alt="좋아요">
				</a>
			</c:forEach>
		</section>
	...
	<div class="container-follow display_none" id="container-follower">
		...
		<div class="title">
			<div>팔로워</div>
			<button>
				<img src="<c:url value="/images/feed/feeds/formdelete.png"/>"
					class="form-close">
			</button>
		</div>
		...
		<div class="follower-members" id="follower-members">
			<div class="member">
				...
				<a href="#">사용자아이디</a> <input type="submit" value="팔로우하기">
